...
public class TrovaUguali {
	...
	public static void main (String[] args) {
		...
		double percVittoria = (double)vittorie / partite;
		System.out.println("Hai giocato " + partite +" volte");
		System.out.println("Hai vinto " + vittorie + " volte");
		System.out.println("La percentuale di successo " + percVittoria + "%");
		System.out.println("L'elaborazione e' durata: " + (stop-start) + "ms");
	}
